...
//const int CS = 16;
const int CS = 2;  // set to Pin 2 for D1 mini Pro
...
const char *ssid = "PBelllAire1"; // Put your SSID here
const char *password = "miltonflorida1"; // Put your PASSWORD here

static IPAddress ip(192, 168, 0, 134); // static IP used for browser access: http://IPaddress
